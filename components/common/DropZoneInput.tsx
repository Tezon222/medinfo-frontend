...
import { DropZone, type DropZoneRootProps } from "@zayne-labs/ui-react/ui/drop-zone";
	...
	return (
		<DropZone.ImagePreview>
			{({ dropZoneState, dropZoneActions }) => (
				<ImagePreviewList
					className={cnMerge(
						`relative mt-[13px] max-h-[140px] divide-y divide-gray-600 overflow-y-auto
						overscroll-y-contain rounded-md border border-gray-600`,
