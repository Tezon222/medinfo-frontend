...
export function DateTimePicker(props: DatePickerProps) {
	const { placeholder, dateValueString = "", formats, className, onChange, variant = "date" } = props;
...
function TimeScrollArea(props: TimeScrollAreaProps) {
	const { dateValue, onChange, formats } = props;

	function handleTimeChange(variant: "hour" | "minute" | "am-pm", value: number | string) {
